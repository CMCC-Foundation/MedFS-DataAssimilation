...
CHARACTER(LEN=2) :: LIST_INSTYPE(NCORATYPES)
  ...
  !... LOOP OVER EXISTING INS FILES
   DO WHILE(LPROCEED)
      WRITE(CFILE,'(A,I3.3)' ) 'PR_'//INSTYPE(1:2)//'_',IFILE
     !jenny  WRITE(CFILE,'(A,I2.2)' ) 'PR_'//INSTYPE(1:2)//'_',IFILE
