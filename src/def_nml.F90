...
!-----------------------------------------------------------------------
  ...
  NAMELIST /ANPPLST/ LL_BOUNDANAL, ZANMAXTEM, ZANMAXSAL,LL_WRITECORRBIN,&
                    LLSHAPIROANL,NN_ITERSHAP,LL_IAU,LL_BOTTOMFILTER,LL_ATLANTIC,NJPI,NJPJ,LL_HRINTERP
  ...
  NAMELIST /RCFLST/ RCF_NTR, RCF_L, RCF_LLVVCR,RCF_LLTSAPART,RCF_TYPE,&
                    ...
                    RF_CORRAD_MFACT, LL_READCOMPSC_LV, LL_WRITECOMPSC_LV,ZMDT_CLS,LL_PRINT_RECFILT
  NAMELIST /SLALST/ SLA_DEP,SLA_USES,LCORRSSH,CSLA_FMT,CSLA_OPT,&
                    LLFILTERSLA,NLANC_KN,ZLANC_CL,SLA_ERR,&
                    LLUSEMDTERR,ZSLANML, LL_VARLNM, LL_UNBIAS_SLA, LL_UNBIAS_SLA_AT ,&
                    LL_IBERR, SLA_REPERR_INFLAT,LL_SLABCORR,NN_SLABC_BY,&
  ...
  NAMELIST /BMDLST/ BMD_DT, BMD_NDY, BMD_ADY, BMD_ALP, BMD_FC1, BMD_FC2,  &
                    BMD_OVR, BMD_RESEM, BMD_NCNT, BMD_NNEOS
  NAMELIST /OBSHAN/ OBSOPT,ZTIME_WEIGTH, LLLATINT_TAB,LL_READALLBIN103,&
                    ...
                    ICOSST_DEF_ERR, NN_REG_REJ, NN_OBS_RET,LL_MISFIT_SIMU
...
! ---
  ...
  WRITE(IOUNLOG,*) ' WHETHER TO REMOVE THE ATLANTIC BOX LL_ATLANTIC = ', LL_ATLANTIC
...
! ---
  ...
  WRITE(IOUNLOG,*) ' RECURS. FILTER OUTPUTS IN LOG FILE LL_PRINT_RECFILT = ',LL_PRINT_RECFILT
...
! ---
  ...
  WRITE(IOUNLOG,*) ' UNBIAS SLA ALONG TRACK    : LL_UNBIAS_SLA= ',LL_UNBIAS_SLA_AT
...
! ---
  ...
  WRITE(IOUNLOG,*) ' NUMBER OF EOS BMD_NNEOS         = ', BMD_NNEOS
...
! ---
  ...
  WRITE(IOUNLOG,*) ' SAVE MISFIT IN SIMULATION RUN=',LL_MISFIT_SIMU
