SUBROUTINE WRITENCOBS(NO,NPI,KM,NF,OOTY,OOPA,OINS,OLON,OLAT,OTIME,&
     & ODEP,OVAL,OERR,ORES,OOMA,OBIA,OI,OJ,OK,OB,OP,OT,OS,NOF,INCR,PERT)
USE SET_KND
USE NETCDF
USE MPIREL
USE RUN
...
REAL(R8), INTENT(IN), DIMENSION(NO) :: OLON,OLAT,&
     & ODEP,OVAL,OERR,ORES,OOMA,OBIA,OB,INCR,PERT
...
INTEGER(I4) :: VARID(22),X_DIMID, P_DIMID, P2_DIMID, K_DIMID, T_DIMID
